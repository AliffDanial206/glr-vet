        ...
        <div class="card-body">
            <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table class="table table-bordered border-info">
                                    ...
                                    <tr>
                                        <th class="text-muted text-white bg-gradient-orange px-2 py-1">Appointment Request Code</th>
                                        <td><?= ($code) ?></td>
                                    </tr>
                                </table>
                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-dark">
                                                    <th class="py-1 px-2 text-light bg-gradient-dark">Contact #</th>
                                                    <td class="py-1 px-2 text-right"><?= ($contact) ?></td>
                                                </tr>
                                                <tr class="border-dark">
                                                    <th class="py-1 px-2 text-light bg-gradient-dark">Email</th>
                                                    <td class="py-1 px-2 text-right"><?= ($email) ?></td>
                                                </tr><tr class="border-dark">
                                                    <th class="py-1 px-2 text-light bg-gradient-dark">Address</th>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true'>
                                            ...
                                            <tbody>
                                                <tr class="border-dark">
                                                    <th class="py-1 px-2 text-light bg-gradient-dark">Pet Type</th>
                                                    <td class="py-1 px-2 text-right"><?= ($pet_type) ?></td>
                                                </tr>
                                                <tr class="border-dark">
                                                    <th class="py-1 px-2 text-light bg-gradient-dark">Breed</th>
                                                    <td class="py-1 px-2 text-right"><?= ($breed) ?></td>
                                                </tr>
                                                <tr class="border-dark">
                                                    <th class="py-1 px-2 text-light bg-gradient-dark">Age</th>
                ...
                <div class="rounded-0 text-center mt-3">
                        ...
                        <a class="btn btn-primary border btn-flat btn-sm" href="./?page=appointments" ><i class="fa fa-angle-left"></i> Back to List</a>
                </div>
            </div>
        </div>
    </div>
