...
<div class="card card-outline card-orange rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">List of Category <small><em>(Pet Types)</em></small></h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn- btn-sm btn-warning"><span class="fas fa-plus"></span>  Add New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								 <button type="button" class="btn btn-round btn-default btn-sm btn-danger dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  		Action
