...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-orange elevation-4 sidebar-no-expand bg-gradient-black">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-transparent text-sm border-info shadow-sm bg-orange">
