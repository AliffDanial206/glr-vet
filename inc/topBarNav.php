...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-orange text-dark" id="login-nav">
      ...
      <nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-warning" id='top-Nav'>
